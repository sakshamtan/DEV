...
// Filter question -> FreeCodeCamp -> Return a new array of objects with only with only title and 
// rating keys. The new array should only include objects where imdbRating is greater than or equal to 8.0. 
...
function filterRatings(watchListObj)
{
  return watchListObj["imdbRating"] >= 8.0;
}

function extractTitleAndRatings(watchListObj)
{
  let obj = {};
  obj.title = watchListObj['Title'];
  obj.rating = watchListObj['imdbRating'];
...
console.log(newFilteredMappedArr);
